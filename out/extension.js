...
function activate(context) {
    ...
    vscode.commands.registerCommand('GlueTreeView.ShowJobRunsReport', async (node) => {
    ...
    vscode.commands.registerCommand('GlueTreeView.TriggerRun', async (node) => {
        await treeView.TriggerRun(node);
    });
    vscode.commands.registerCommand('GlueTreeView.TriggerWithPayload', async (node) => {
    ...
    vscode.commands.registerCommand('GlueTreeView.OpenJobCode', async (node) => {
        await treeView.OpenJobCode(node);
    });
    vscode.commands.registerCommand('GlueTreeView.DiffJobCode', async (node) => {
        await treeView.DiffJobCode(node);
    });
